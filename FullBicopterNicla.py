...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0.01) #2
    ...
    try:
        while True:
            ...
            # Button inputs: [Z, X, C, V] mapped vto [A, B, X, Y]
            axis, buttons = joystick.getKeyboardInputs()
